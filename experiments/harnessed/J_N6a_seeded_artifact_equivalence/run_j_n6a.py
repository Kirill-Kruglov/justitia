...
def experiment() -> dict:
    ...
    seed_report = SP.enforce_seed_policy([
        {"metric": "J_N6a_seeded_artifact_default_equivalence", "role": "core", "seeds": len(thresholds["seeds"]), "pass_fail": "PASS"},
    ])
    ...
    return {
        "question": "Do seeded artifact-channel neutral defaults exactly preserve committed J-G1 headline summary cells?",
        ...
        "downstream_consequence": "PASS permits J-N6/J-N6b preregistration; FAIL stops FW-2b until implementation is fixed and re-reviewed.",
        ...
        "what_was_not_shown": "This gate does not evaluate A1s/A2s/A2f or any non-default artifact-channel behavior.",
    }
