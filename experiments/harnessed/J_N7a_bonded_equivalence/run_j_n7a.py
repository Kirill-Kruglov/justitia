...
def experiment() -> dict:
    ...
    seed_report = SP.enforce_seed_policy([
        {"metric": "J_N7a_bonded_artifact_default_equivalence", "role": "core", "seeds": len(thresholds["seeds"]), "pass_fail": "PASS"},
    ])
    ...
    return {
        "question": "Do bonded artifact-channel neutral defaults exactly preserve committed J-G1 headline summary cells?",
        ...
        "downstream_consequence": "PASS permits J-N7/J-N7b preregistration; FAIL stops FW-3 until implementation is fixed and re-reviewed.",
        ...
        "what_was_not_shown": "This gate does not evaluate F1/P0/P1-low/P1-high or any non-default bonded artifact behavior.",
    }
